...
export function extractGrade(arabic: string, english: string): GradeInfo | undefined {
    ...
    const gradePatterns = {
        'صحيح': [/حديث صحيح/, /صحيح$/i, /وقال.*صحيح/, /رواه.*صحيح/, /في صحيحيهما/i, /في \"صحيحيهما\"/i],
        ...
        'متفق عليه': [/متفق عليه/, /رواه البخاري ومسلم/, /في صحيحيهما/i, /في \"صحيحيهما\"/i],
        'صحيح البخاري': [/رواه البخاري/, /في صحيح البخاري/, /صحيح البخاري/i],
        'صحيح مسلم': [/رواه مسلم/, /في صحيح مسلم/, /صحيح مسلم/i],
    };
